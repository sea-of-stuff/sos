 ...
 */
public class SecureCompoundManifestSerializer extends JsonSerializer<SecureCompound> {

    @Override
    public void serialize(SecureCompound compoundManifest, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
    ...
    private void serializeContents(SecureCompound compoundManifest, JsonGenerator jsonGenerator) throws IOException {
