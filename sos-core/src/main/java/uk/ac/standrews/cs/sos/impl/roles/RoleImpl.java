...
public class RoleImpl extends UserImpl implements Role {
    ...
    private void manageProtectionKey(boolean loadOnly) throws ProtectionException {
        ...
        try {
            File publicKeyFile = new File(KEYS_FOLDER + guid() + "_pub" + AsymmetricEncryption.KEY_EXTENSION);
            ...
            File privateKeyFile = new File(KEYS_FOLDER + guid() + AsymmetricEncryption.KEY_EXTENSION);
            ...
            if (!loadOnly && protectionPublicKey == null && protectionPrivateKey == null) {
                ...
                AsymmetricEncryption.persist(asymmetricKeys, Paths.get(KEYS_FOLDER + guid()), Paths.get(KEYS_FOLDER + guid() + "_pub"));
            }
