...
public class ProtocolTest extends SetUpTest {
    ...
    PublicKey mockD_PublicKey;

    @BeforeMethod
    public void setUp() throws GUIDGenerationException, ConfigurationException, IOException, SOSException {

        mockD_PublicKey = null;
        // The code below is needed to test the calls for verifying the incoming signed requests
        // Unable to partial mock/spy DigitalSignature.
//        try {
//            mockD_PublicKey = mock(PublicKey.class);
