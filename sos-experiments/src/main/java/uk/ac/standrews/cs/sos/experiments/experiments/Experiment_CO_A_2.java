 ...
 */
public class Experiment_CO_A_2 extends BaseExperiment implements Experiment {

    public Experiment_CO_A_2(ExperimentConfiguration experimentConfiguration) throws ExperimentException {
        super(experimentConfiguration);
    }

    public Experiment_CO_A_2(ExperimentConfiguration experimentConfiguration, String outputFilename) throws ExperimentException {
        super(experimentConfiguration, outputFilename);
    }

    @Override
    public ExperimentUnit getExperimentUnit() {
        return new ExperimentUnit_CO_A_2();
    }
    ...
    private class ExperimentUnit_CO_A_2 implements ExperimentUnit {
    ...
    public static void main(String[] args) throws ExperimentException, ConfigurationException {
        ...
        Experiment_CO_A_2 experiment_co_a_2 = new Experiment_CO_A_2(experimentConfiguration);
        experiment_co_a_2.process();
    }
