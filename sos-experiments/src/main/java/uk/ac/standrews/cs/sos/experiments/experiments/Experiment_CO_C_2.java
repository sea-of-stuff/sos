 ...
 */
public class Experiment_CO_C_2 extends BaseExperiment implements Experiment {

    public Experiment_CO_C_2(ExperimentConfiguration experimentConfiguration) throws ExperimentException {
        super(experimentConfiguration);
    }

    public Experiment_CO_C_2(ExperimentConfiguration experimentConfiguration, String outputFilename) throws ExperimentException {
        super(experimentConfiguration, outputFilename);
    }

    @Override
    public ExperimentUnit getExperimentUnit() {
        return new ExperimentUnit_CO_C_2();
    }
    ...
    private class ExperimentUnit_CO_C_2 implements ExperimentUnit {
    ...
    public static void main(String[] args) throws ExperimentException, ConfigurationException {
        ...
        File experimentConfigurationFile = new File(CONFIGURATION_FOLDER.replace("{experiment}", "co_c_2") + "configuration.json");
        ExperimentConfiguration experimentConfiguration = new ExperimentConfiguration(experimentConfigurationFile);

        Experiment_CO_C_2 experiment_co_c_2 = new Experiment_CO_C_2(experimentConfiguration);
        experiment_co_c_2.process();
    }
